...
import { JSONFile } from 'lowdb/node'; // <= compatible con Node 20 ESM
...
if (!db.data.users || db.data.users.length === 0) {
  ...
  await db.write();
  console.log('✅ Usuario por defecto: admin / demo123');
}
...
app.listen(PORT, () => console.log('🚀 Secure API corriendo en', PORT));
